...
class Utils(commands.Cog):
    ...
    @commands.command(aliases=['addtodo'], description='Adds a TODO to the list of things that will probably never be done. I hate myself. Life is suffering. The endless oblivion of things that should be done will eventually catch up with us all, causing devastation, chaos and misery. You really want to contribute to it? That "one additional thing we have to do" which you will NEVER do? Think twice before adding anything, please.')
